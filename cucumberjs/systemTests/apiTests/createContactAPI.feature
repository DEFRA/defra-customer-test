...
The D365 WebAPI Create Contact Actions can be called using the Microsoft provided guidelines
  ...
  Scenario Outline: Creating a UK - <ContactType> - Contact-type with <ValidationType>
    ...
    Examples:
      | ContactType | ValidationType               | StatusMsgCont                     |
      # | Non_Citizen | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) |  
      # | Non_Citizen | NonUKCor_OthersUKAddresses   | (contactid,defra_uniquereference) |
      | Non_Citizen | NonUKCor_NonUKOtherAddresses | (contactid,defra_uniquereference) |  
 ...
 #3
  @api2-Done @smoke-Test @SmokeContactx
  Scenario Outline: UPDATE an existing - <ContactType> - Contact details
    # Given I am a Web API user
    When I create a new <ContactType> Contact with <ValidationType> then expected message outcome is <StatusMsgCont>
    And I EDIT the newly created Contacts <EditedField> field then expected message outcome is <UpdateMsgCont>
    # Then a new Contact record should be created
    Examples:
     | ContactType | ValidationType               | StatusMsgCont                     | EditedField  | UpdateMsgCont |
     | Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | firstName    |  OK           |
     | Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | lastName     |  OK           |
     | Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | phone        |  OK           |
     | Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | email        |  OK           |
    #  | Non_Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | firstName    |  OK           |
    #  | Non_Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | lastName     |  OK           |
    #  | Non_Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | phone        |  OK           |
    #  | Non_Citizen     | UKCorAdd_OthersUKAddresses   | (contactid,defra_uniquereference) | email        |  OK           |